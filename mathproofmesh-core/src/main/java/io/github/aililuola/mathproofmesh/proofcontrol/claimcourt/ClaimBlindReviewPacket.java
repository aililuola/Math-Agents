...
/** Identity-scrubbed input for the final proof referee. */
public record ClaimBlindReviewPacket(
    String courtCaseId,
    String problemHash,
    String rootGoalHash,
    String claimId,
    ...
    List<String> verifiedDependencyClaimIds,
    List<EvidenceRef> trustedEvidenceRefs) {
  public ClaimBlindReviewPacket {
    ...
    proofRevisionId = ClaimCourtValues.required(proofRevisionId, "proofRevisionId");
    proofHash = ClaimCourtValues.required(proofHash, "proofHash");
    proofSteps = ClaimCourtValues.copy(proofSteps);
    verifiedDependencyClaimIds = ClaimCourtValues.copy(verifiedDependencyClaimIds);
    trustedEvidenceRefs = ClaimCourtValues.copy(trustedEvidenceRefs);
  }
  ...
  @Override
  public List<String> verifiedDependencyClaimIds() {
    return List.copyOf(verifiedDependencyClaimIds);
  }

  @Override
  public List<EvidenceRef> trustedEvidenceRefs() {
    return List.copyOf(trustedEvidenceRefs);
  }
}
